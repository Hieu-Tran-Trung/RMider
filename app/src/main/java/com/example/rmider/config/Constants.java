...
public class Constants {
    ...
    public static final int TYPE_VATCHAT =14;
    public static final int TYPE_BATBUOC =15;
    public static final int TYPE_DANGKIEM =16;
    public static final int TYPE_LOAIKHAC =17;
